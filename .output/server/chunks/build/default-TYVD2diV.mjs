import { ref, watch, resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, withModifiers, renderSlot, useSSRContext } from 'vue';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_main, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_container, { class: "h-100 align-center justify-center d-flex flex-column" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                        ...
                        return [
                          createVNode(_component_v_container, { class: "h-100 align-center justify-center d-flex flex-column" }, {
                            default: withCtx(() => [
                              renderSlot(_ctx.$slots, "default")
                            ]),
                            _: 3
...
//# sourceMappingURL=default-TYVD2diV.mjs.map
